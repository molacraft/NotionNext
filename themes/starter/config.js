...
const CONFIG = {
  ...
  // 英雄区配图，如需隐藏，改为空值即可 ''
  STARTER_HERO_PREVIEW_IMAGE: 'public/images/starter/hero/mola1.webp', // 产品预览图 ，默认读取public目录下图片
  STARTER_HERO_BANNER_IMAGE: 'public/images/starter/hero/mola1.webp', // hero区下方的全宽图
